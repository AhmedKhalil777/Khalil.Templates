...
namespace Sample Company.Infrastructure.Data;
...
public class TodoDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TodoItem>().HasData(
            ...
            {
                Id = 1,
                Title = "Setup Sample Company Project",
                Description = "Initialize the Sample Company project with proper architecture",
